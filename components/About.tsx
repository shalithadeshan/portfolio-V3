    ...
    <div className="container content-center grid" style={{ height: "100vh" }}>
      ...
      <div className="grid justify-items-center md:grid-cols-2 gap-10 mt-10">
        ...
        <div className="order-1 md:order-2">
          <Image
            src={profile}
            className="h-64 w-auto object-cover rounded-md transform hover:scale-110 transition ease-out duration-300 relative z-[1]"
            alt="Shalitha Jayasekara"
            priority
          />
          <div
            className="border-2 rounded-lg transform hover:rotate-6 hover:translate-x-2 ease-out duration-300 border-secondary-color p-32 mt-8 ml-5 relative"
