    ...
    <div className="container content-center grid" style={{ height: "80vh" }}>
      ...
      <div className="text-center mt-10">
        ...
        <div className="flex justify-center">
          <p className="text-dark-color text-lg md:w-96">
        ...
        <div className="flex justify-center mt-5">
          <a href="mailto:shalithad8520jayasekara@gmail.com">
            <div className="rounded-md border-2 w-max border-secondary-color py-2 px-5 text-secondary-color hover:bg-secondary-color hover:text-black cursor-pointer">
              Say Hello
            </div>
          </a>
        </div>
